...
```sh
git tag -a v0.1.0-r3 -m "soya-asn-router v0.1.0-r3"
git push origin v0.1.0-r3
```
...
```sh
openwrt-24.10.4-mediatek-filogic-soya-asn-router_0.1.0-r3_aarch64_cortex-a53.ipk
openwrt-24.10.4-mediatek-filogic-luci-app-soya-asn-router_*.ipk
openwrt-25.12.2-mediatek-filogic-soya-asn-router_0.1.0-r3_aarch64_cortex-a53.ipk
